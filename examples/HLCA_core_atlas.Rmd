...
# Identify metacell per sample in each dataset with SuperCell through MetacellToolkit command line
...
We identify at the metacell level the markers for the rare cell type Smooth muscle FAM83D+ and Migratory DCs and check if we correctly retrieve the genes highlithed in the original study.
...
combined.mc <- harmony::RunHarmony(combined.mc,c("dataset"))
